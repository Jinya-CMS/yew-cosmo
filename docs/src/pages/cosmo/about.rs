...
pub fn about_cosmo() -> Html {
    html!(
        <>
            <CosmoTitle title="Cosmo CSS (for Yew) by Jinya" />
            <CosmoHeader level={CosmoHeaderLevel::H2} header="What is Cosmo CSS (for Yew)" />
            <CosmoParagraph>
            ...
            <CosmoHeader level={CosmoHeaderLevel::H2} header="What Cosmo CSS (for Yew) is not" />
            <CosmoParagraph>
            ...
            <CosmoParagraph>
                {"Installing Cosmo CSS (for Yew) is simple, just add the crate  "}<CosmoCode>{"yew-cosmo"}</CosmoCode>{" to your Cargo.toml and you are good to go."}
            </CosmoParagraph>
            ...
            <CosmoParagraph>{"Like all other Jinya projects, Cosmo CSS (for Yew) is distributed under the MIT License."}</CosmoParagraph>
        </>
    )
}
